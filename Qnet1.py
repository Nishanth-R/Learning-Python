# Checklist for my first Q Net Program
# 1. Identify what I want to do:Reward Maximization reinforcement learning 
# 2. Find an appropriate problem : OpenAI gym-Cartpole
# 3. Choose an appropriate model : DQN
# 4. Code!
import gym
